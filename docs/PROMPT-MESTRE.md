...
Fases 0 a 52. 441 testes em 43 suítes, sem falha conhecida — treze rodadas
...
PostgreSQL 16 com RLS, 17 partições isoladas, 74 migrações, 90 tabelas.
...
2.1 AA) nas 107 telas. Cor nova passa por ele antes de entrar.
