...
137 migrações em ordem e aplica os seeds (`seed.ts`, `seed-fase2.ts`, `seed-fase4.ts`).
...
Constrói, cria um banco virgem, aplica as 137 migrações **pelo binário
