...
| **104 suítes** | `backend/test/*.spec.ts` |
| **992 testes** | `it(` / `test(` nas suítes |
...
│   ├── test/              104 suítes (e2e contra PostgreSQL real + estáticas)
