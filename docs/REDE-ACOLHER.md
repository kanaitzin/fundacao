...
| **101 suítes** | `backend/test/*.spec.ts` |
| **969 testes** | `it(` / `test(` nas suítes |
...
│   ├── test/              101 suítes (e2e contra PostgreSQL real + estáticas)
